...
public class PaddedBufferedBlockCipher extends BufferedBlockCipher {
	...
	/**
	 * return the minimum size of the output buffer required for an update plus
	 * a doFinal with an input of len bytes.
	 * 
	 * @param len
	 ...
	 * padding needs to be added a call to doFinal will produce 2 *
	 * getBlockSize() bytes.
	 * 
	 * @param out
	 ...
	 * @return the number of output bytes copied to out.
	 * @exception DataLengthException
	 *                if there is insufficient space in out for the output or we
	 *                are decrypting and the input is not block size aligned.
	 * @exception IllegalStateException
