 ...
 * 
 * Do not use this class without calling setSeed at least once</b>! There are
...
public class SecureRandom extends java.util.Random {
	...
	private static final RandomGenerator sha1Generator = new DigestRandomGenerator(
			new SHA1Digest());
	private static final RandomGenerator sha256Generator = new DigestRandomGenerator(
			new SHA256Digest());
